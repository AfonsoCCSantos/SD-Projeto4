...
void   message_t__entry_message__init
                     (MessageT__EntryMessage         *message)
{
  static const MessageT__EntryMessage init_value = MESSAGE_T__ENTRY_MESSAGE__INIT;
  *message = init_value;
}
...
static const ProtobufCFieldDescriptor message_t__entry_message__field_descriptors[2] =
{
  {
    "key",
    1,
    ...
    0,   /* quantifier_offset */
    offsetof(MessageT__EntryMessage, key),
    NULL,
  ...
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(MessageT__EntryMessage, data),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned message_t__entry_message__field_indices_by_name[] = {
  1,   /* field[1] = data */
  0,   /* field[0] = key */
};
static const ProtobufCIntRange message_t__entry_message__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 2 }
};
const ProtobufCMessageDescriptor message_t__entry_message__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "message_t.EntryMessage",
  "EntryMessage",
  "MessageT__EntryMessage",
  "",
  sizeof(MessageT__EntryMessage),
  2,
  message_t__entry_message__field_descriptors,
  message_t__entry_message__field_indices_by_name,
  1,  message_t__entry_message__number_ranges,
  (ProtobufCMessageInit) message_t__entry_message__init,
...
static const ProtobufCFieldDescriptor message_t__field_descriptors[5] =
{
  ...
  },
  {
    ...
    &message_t__entry_message__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
