...
typedef struct _MessageT__EntryMessage MessageT__EntryMessage;
...
struct  _MessageT__EntryMessage
{
  ProtobufCMessage base;
  char *key;
  ProtobufCBinaryData data;
};
#define MESSAGE_T__ENTRY_MESSAGE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&message_t__entry_message__descriptor) \
...
#define MESSAGE_T__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&message_t__descriptor) \
    , MESSAGE_T__OPCODE__OP_BAD, MESSAGE_T__C_TYPE__CT_BAD, NULL, 0,NULL, 0 }


/* MessageT__EntryMessage methods */
...
typedef void (*MessageT__EntryMessage_Closure)
                 (const MessageT__EntryMessage *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor message_t__entry_message__descriptor;
